...
<div class="sw-project swcontainer">
    <div class="sw-pro-tab clearfix">
        ...
        <a href="{{url('meetIndex')}}" class="active swcol-md-4 swcol-xs-12">约见投资人</a>
        ...
        <div class="sw-pro-tabcon show">
            ...
            <div class="sw-pro-form">
                ...
                <div class="sw-pro-row clearfix forbidden">
                    ...
                    <div class="swcol-md-8 sw-pro-rowcon"><input type="text" id="name" class="sw-name" disabled value="{{$expertData->expertname}}"></div>
                </div>
                ...
                <div class="sw-pro-row clearfix">
                    ...
                    <div class="swcol-md-8 sw-pro-rowcon"><input type="text" disabled id="linefee" class="sw-linefee" value="{{$meetData->price}}元"></div>
                </div>
                ...
                <div class="sw-pro-row clearfix linefee">
                    ...
                    <div class="swcol-md-8 sw-pro-rowcon"><input type="text" disabled class="sw-time"  value="{{$basedata['time'] or ''}}"></div>
                </div>
