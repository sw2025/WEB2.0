...
@section("content")
            ...
            <div class="main-right">
                        ...
                        @foreach($datas as $data)
                            <div class="vid-man-top-lt vid-man-top-main">
                                <div class="vid-man-top-con">
                                    <p class="vid-man-top-cat"><span class="light-color">会议标题：</span>{{$data->domain1}}</p>
                ...
                <div class="wrapper box-sizing">
                    <div class="content">
						...
						<span class="chat-btn msg-type" id="chooseFileBtn">
							<a class="icon icon-file" data-type="file"></a>
                                    ...
                                    <a class="chat-btn u-netcall-video-link" title="视频通话" id="showNetcallVideoLink">&nbsp;</a>
                    ...
                    <div class="chat-room-btns">
                        <button type="button" class="chat-room-btn unusual-btn">终止私董会</button>
   ...
   {{-- <script src="{{asset('im/3rd/platform.js')}}"></script>--}}
    ...
    <script>
      ...
      /*  layer.tips('点此视频通话', '#showNetcallVideoLink', {
            tips: [4, '#e25633'],
            time: 6000
        });*/
        $(".unusual-btn").on('click',function(){
            var consultId=$('#consult').val();
            layer.prompt({title: '请输入终止私董会原因', formType: 2}, function(pass, index){
                if(pass == ''){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        if(res['code']=='success'){
                            window.location="{{url('entmysector/mysectorindex')}}";
                        }else{
