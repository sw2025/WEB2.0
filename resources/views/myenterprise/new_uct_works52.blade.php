                                ...
                                <div class="vid-man-top-rt vid-man-top-main">
                                    <div class="vid-man-top-con">
                                        ...
                                        <div class="camera-comunicate">
                                            <span class="camera"><img src="img/camera.png" /></span>
                            ...
                            <div class="works-manage">
                                <div class="works-first execute works-manage-step">
                                    <div class="w-f-top">
                                        ...
                                        <p class="handle-affair-desc">专家开出办事所需资料的目录，<br />企业确认后进入下一阶段。</p>
                                        <a href="javascript:;" class="datum-btn datum-history"><i class="iconfont icon-yijianfankui"></i>查看历史意见<span class="history-counts">99</span></a>
                                    </div>
    ...
    $(function(){
        ...
        $('.datum-confirm').bind('click', function(event) {
            ...
            layer.confirm('资料确认无误吗？', {
                ...
                window.location.href="new_uct_works53.html";
            })
        });
        // 点击修改意见
