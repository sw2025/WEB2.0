                ...
                <div class="publish-need uct-works default-result">
                    @foreach($datas as $data)
                        ...
                        <div class="publish-need-sel">
                            <span class="publ-need-sel-cap">问题分类</span>
                            <a href="javascript:;" class="publ-need-sel-def verify-default">{{$data->domain1.'/'.$data->domain2}}</a>
                        ...
                        <textarea readonly="readonly" class="publish-need-txt uct-works-txt" cols="30" rows="10"
                                  placeholder="请输入办事描述">{{$data->brief}}</textarea>
                        <div class="uct-works-exp">
                            <a href="javascript:;"
                               class="special-btn  uct-works-btn  @if($data->state=='指定专家') active @endif">指定专家</a>
                            <a href="javascript:;"
                               class="system-btn2 uct-works-btn @if($data->state=='系统分配') active @endif ">系统分配</a>
                        </div>
                    @endforeach
                </div>
            </div>
