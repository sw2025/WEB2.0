                    ...
                    @foreach($datas as $data)
                        <div class="expert-certy-state">
                            <i class="iconfont icon-chenggong"></i>
                                    <span class="publish-need-blue">
                                        <em>审核失败</em>IS REVIEWING
                                    </span>
                        </div>
                        <div class="reject-reason"><span>拒绝原因：</span>{{$data->remark}}</div>
                        ...
                        <div class="calendar">
                            <div class="calendar-start clearfix">
                                <span>开始时间</span><span class="calendar-date laydate-icon">{{$data->starttime}}</span>
                            </div>
                            <div class="calendar-end clearfix">
                                <span>结束时间</span><span class="calendar-date laydate-icon">{{$data->endtime}}</span>
                            </div>
                        </div>
