        ...
        <div class="ucenter-con">
            <div class="main-right">
                <div class="card-step works-step">
                    <span class="green-circle">1</span>约见专家<span class="card-step-cap">&gt;</span>
                    <span class="green-circle">2</span>等待确认<span class="card-step-cap">&gt;</span>
                    <span class="green-circle">3</span>已经确认<span class="card-step-cap">&gt;</span>
                    <span class="green-circle">4</span>线下约谈<span class="card-step-cap"></span>
                </div>
                <div class="invite-experts apply-video-wrapper">
                    <table class="invite-table">
                        ...
                        <tr>
                            <td>问题描述</td>
                            <td>
                                <textarea disabled="disabled" class="publish-need-txt uct-works-txt" cols="30" rows="10" >{{$data->contents}}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>约见时长</td>
                    ...
                    <div class="uct-works-con">
                        <button class="test-btn submit-audit" type="button" disabled="disabled">线下约谈</button>
                    </div>
                </div>
            </div>
        </div>
