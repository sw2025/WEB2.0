                                ...
                                <div class="vid-man-top-rt vid-man-top-main">
                                    <div class="vid-man-top-con">
                                        <div class="emcee">
                                            ...
                                            @foreach($comperes as $compere)
                                                <span class="emceer-pers"><img src="{{$compere->avatar}}" class="vid-new-ava">{{$compere->nickname}}</span>
                                            @endforeach
                                        </div>
                                        <div class="emcee-bottom">
                                            ...
                                            <div class="emcee-members">
                                                ...
                                                <span class="emceer-pers"><img src="{{$selExpert->showimage}}" class="vid-new-ava">{{$selExpert->expertname}}</span>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
