...
@section("content")
    ...
    <div class="ucenter-con">
        ...
        <div class="v-myneed-top">
            <a href="javascript:;" class="v-release-btn" onclick="putneed()">发布项目</a>
            <div class="v-condition">
                ...
                <a href="javascript:;" class="v-condition-link v-c-link1 @if(!empty($action) && $action == '评议中')active @endif" index="waitverify">评议中<span class="v-count">{{$waitcount}}</span></a>
                <a href="javascript:;" class="v-condition-link v-c-link2 @if(!empty($action) && $action == '已完成')active @endif" index="refuseverify">已完成<span class="v-count">{{$refusecount}}</span></a>
            </div>
        </div>
        <!-- 选择  end -->
        ...
        <div class="main-right uct-oh">
            <div class="myask-tab-box">
                <ul class="supply-list clearfix">
                    @foreach($datas as $v)
                        <li class="col-md-6">
                            <a href=" {{url('uct_myshow/showDetail',$v->showid)}}" class="supply-list-link">
