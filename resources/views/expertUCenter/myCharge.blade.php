        ...
        <div class="my-money">
            <div class="my-money-top">
                <div class="m-t-left">
                    ...
                    <div class="m-t-l-income"><span><b>未提现&nbsp;&nbsp;￥</b>{{$balance or 0}}</span><a href="chargeStandard.html" class="sw-recharge-btn">收费设置</a></div>
                </div>
                <div class="sw-upload-bankcard">
                    ...
                    <div class="sw-card-upload" @if(empty($bankcard) || $state==1)style="display:inline-block" @else style="display: none" @endif>
                        <div class="card-span fileinput-button">
                            <span class="swcard-upload-tip"><a href="{{asset('recharge/card')}}"><i class="iconfont icon-add"></i>添加银行卡</a></span>
                        </div>
                    </div>
