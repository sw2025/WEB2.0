...
@section("content")
                ...
                <div class="swcontainer">
                    <div class="sw-banner-content">
                        ...
                        <div class="sw-banner-links">
                            <a href="{{url('submitIndex')}}" class="hover">直通路演(免费)</a> <a href="{{url('showIndex')}}" >直通VC</a><a href="{{url('meetIndex')}}">约见投资人</a>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <div class="swcontainer investor">
        ...
        <div class="investor-wrapper">
            @foreach($datas as $v)
                ...
                <span class="investor-field">擅长领域：
    ...
    <div class="institution"  style="">
        <div class="swcontainer institution-wrapper">
            <span class="investor-title">实力机构</span>
            <div class="institution-brand">
                <span><img src="img/partner01.png"></span>
                <span><img src="img/partner02.png"></span>
                <span><img src="img/partner03.png"></span>
                <span><img src="img/partner04.png"></span>
                <span><img src="img/partner05.png"></span>
                <span><img src="img/partner06.png"></span>
                <span><img src="img/partner07.png"></span>
                <span><img src="img/partner08.png"></span>
                <span><img src="img/partner09.png"></span>
                <span><img src="img/partner10.png"></span>
            </div>
