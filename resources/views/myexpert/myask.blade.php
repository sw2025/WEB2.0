                ...
                <div class="main-right">
                    <div class="mywork-wrap">
                        <table class="paycheck-list">
                            ...
                            <tbody>
                            <tr>
                                <td><a href="{{asset('uct_myask/askDetail')}}">办事类型</a></td>
                                <td><a href="{{asset('uct_myask/askDetail')}}">北京中博昊达资产管理有限公司</a></td>
                                <td><a href="{{asset('uct_myask/askDetail')}}">需求描述</a></td>
                                <td><a href="{{asset('uct_myask/askDetail')}}">2017-07-12</a></td>
                            </tr>
                            <tr>
