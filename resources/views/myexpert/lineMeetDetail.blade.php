...
@section("content")
    <div class="bg_v2">
        <div class="card-step works-step">
            ...
            <span class="gray-circle">3</span>确认约见<span class="card-step-cap">&gt;</span>
        ...
        <div class="invite-experts">
            ...
            <br><br>
        <div>
            <span class="accept" style="width: 200px;margin-left:400px;" onclick="responseevent({{$datas->id}},this)">接 受</span>
        </div>
