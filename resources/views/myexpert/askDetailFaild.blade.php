...
@section("content")
    ...
    <div class="main">
        <!-- 企业视频咨询服务 / start -->
        <h3 class="main-top">企业视频咨询服务</h3>
        <div class="ucenter-con">
            <div class="main-right">
                <div class="card-step works-step">
                    <span class="green-circle">1</span>视频咨询申请<span class="card-step-cap">&gt;</span>
                    ...
                    <span class="green-circle">4</span>视频咨询管理<span class="card-step-cap">&gt;</span>
                ...
                <div class="publish-need uct-works-final">
                    <div class="expert-certy-state">
                                ...
                                <span class="expert-certy-blue">
                                    ...
                                    <em style="color: #f10;font-weight: bolder;">视频咨询失效</em>Abnormal termination
                                </span>
                    </div>
                        <table class="table table-striped" style="width: 80%;margin: 10px auto;">
                            ...
                            <tr>
                                <th>视频咨询描述</th>
                                <td>{{mb_substr($datas->brief,0,50)}}</td>
                            </tr>
                            <tr>
                                <th>视频咨询专家</th>
                                <td><a href="{{url('expert/detail',$expertid->expertid)}}">{{$expertid->expertname}}</a></td>
                            </tr>
