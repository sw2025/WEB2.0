...
<div class="sw-project swcontainer">
    <div class="sw-pro-tab clearfix">
        <a href="javascript:;" class="swcol-md-4 swcol-xs-12">VC直评</a>
        ...
        <div class="sw-pro-tabcon show">
            ...
            <div class="sw-pro-form">
                ...
                <div class="sw-pro-row clearfix">
                    ...
                    <div class="swcol-md-8 sw-pro-rowcon"><input type="text" disabled placeholder="输入联系人" class="sw-enterjob" value="{{$lineShowData->job or ''}} "></div>
                </div>
                <div class="sw-pro-row clearfix">
