    ...
    <div class="serve-stage stage-us container">
        ...
        <div class="who">
            ...
            <div class="about-desc">
                升维网（www.swchina.com）是为广大中小企业提供资源精准对接，以解决实际问题为导向，为广大中小企业的转型升级提供一站式服务的的大型平台。
                <br />
                ...
                <ul class="core-list2">
                    <li class="core-item">
                        ...
                        <div class="core-hover">
                            ...
                            <p class="core-desc" style='height: 130px;font-size: 12px;'>经济学博士，资深金融投资专家，长期从事金融投资管理工作。认为企业转型升级的关键，在于如何高效率使用外部资源。企业使用外部资源的核心又在于如何消除隐藏信息不对称之下的知识不对称和组织不对称。而这正是升维网的价值所在。</p>
                        </div>
                    </li>

                      <li class="core-item" style="    height: 430px;">
                        <img src="{{env('ImagePath')}}/images/daxinge.jpg" class="core-pic" title="" />
                        <div class="core-hover">
                            <div class="core-top">
                                <strong>王大盺</strong>
                                <span class="job2">资源拓展总监</span>
                            </div>
                            <img src="{{env('ImagePath')}}/images/daxinge.jpg" class="core-img2" />
                            <p class="core-desc" style='height: 150px;font-size: 12px;'>资深公关体验营销专家，2005年进入当中国公关20强趋势中国工作，从事公关活动工作16年，服务合作过近百家500强公司，对中国市场精准而全面的把握，特别是在整合营销传播、活动管理方面的丰富资源，对于将品牌定位及市场传播、活动策划结合，对客户的帮助和引导有着自己独特的见解。</p>
                        </div>
                    </li>
                     <li class="core-item">
                        <img src="{{env('ImagePath')}}/images/chenjinan.jpg" class="core-pic" title="" />
                        <div class="core-hover">
                            <div class="core-top">
                                <strong>陈冀南</strong>
                                <span class="job2">运营总监</span>
                            </div>
                            <img src="{{env('ImagePath')}}/images/chenjinan.jpg" class="core-img2" />
                            <p class="core-desc">深耕互联网行业多年，在多家知名互联网创业公司负责市场和运营板块，拥有广泛的媒体传播和行业渠道资源，多次为初创企业成功实现从0到1的突破。</p>
                        </div>
                    </li>
                    ...
                    <li class="core-item">
                        ...
                        <div class="core-hover"> 
                            ...
                            <p class="core-desc" style='height: 130px;font-size: 12px;'>知名高校行政管理专业硕士。曾在多家大型上市公司担任行政管理职位，具有丰富的行政管理经验及较强的综合协调能力。精通韩语 英语 等多门外语</p>
                        </div>
                    </li>
                    <li class="core-item">
                        ...
                        <div class="core-hover">
                            ...
                            <p class="core-desc" style="height:130px;font-size: 12px;">曾在多家大型上市公司担任商务管理职位，具有证券公司、公募基金、私募基金、资产管理机构等核心人脉资源，精通各种面向企业用户的产品拓展方式，市场拓展能力等。基于企业服务发展整体战略， 结合公司目前发展战略，探索，挖掘可持续发展的新机会。</p>
                        </div>
                    </li>
                    <li class="core-item">
                        ...
                        <div class="core-hover">
                            ...
                            <p class="core-desc" style='height: 130px;font-size: 12px;'>负责升维网运维微信广告、百度推广等平台，策划、执行广告方案；负责百度搜索引擎的竞价工作，搜索关键词的优化调整；负责公司网站的SEO优化工作，提高公司网站在百度的自然搜索排名；定期撰写公司网络营销的数据分析，推广效果分析。</p>
                        </div>
                    </li>
                    <li class="core-item">
                        ...
                        <div class="core-hover">
                            ...
                            <p class="core-desc" style="height: 130px;font-size: 12px;">曾负责多家公司网站及网站后台管理系统搭建,调研相关平台架构设计和研发;负责系统的高可用，完成重要业务模块及核心代码实现;高性能Web应用架构设计和优化;主导开发小组成员的Code Review工作，并能提供性能优化、安全性建议</p>
                        </div>
                    </li>
