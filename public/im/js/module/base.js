    ...
    if(scene=="p2p"){
        ...
        if(info){
            if(info.avatar){
                ...
                this.$chatTitle.find('img').attr('src', "../../im/images/" + info.type + ".png")
            }
            ...
            this.$chatTitle.find('img').attr('src', "../../im/images/normal.png")
            this.$nickName.text("视频讨论组")
        }
    ...
    switch(type){
            ...
            if(scene==="p2p"){
                ...
                if(teamInfo){
                    ...
                    if(teamInfo.avatar){
                        ...
                        info.avatar = "../../im/images/"+teamInfo.type+".png"
                    }
                }else{
                    info.nick = msg.target
                    info.avatar = "../../im/images/normal.png"
                }   
            }
        break
        case "friend":
        ...
        case "team":
            ...
            if(data.avatar){
                ...
                info.avatar = info.type==="normal"?"../../im/images/normal.png":"../../im/images/advanced.png"
            }
            info.crtSession = this.crtSession  
        break
    }
